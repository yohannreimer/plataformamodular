  ...
  return (
    <div className="page dashboard-page">
      ...
      <div className="kpi-grid">
        <KpiCard label="Turmas em aberto" value={data.cards.open_cohorts} hint="Visão executiva da operação ativa." />
        <KpiCard label="Próximas turmas (7 dias)" value={data.cards.next_7_days} hint="Volume já planejado para os próximos dias." />
        <KpiCard label="Turmas sem quórum" value={data.cards.cohorts_without_quorum} hint="Risco imediato de atraso na agenda." />
        <KpiCard label="Clientes travados (MOD-01)" value={data.cards.blocked_by_installation} hint="Ponto de bloqueio para progresso de jornada." />
      </div>
      ...
      <div className="two-col">
        <Panel title="Pendências por módulo" action={
          <input
        ...
        <Panel title="Gargalo por técnico" action={
          <input
