...
export function AdminPage() {
  ...
  return (
    <div className="page admin-page">
      ...
      <Panel title="Carga de base e importação">
      ...
      <Panel title="Acesso global do Portal do Cliente">
        <p className="form-hint">
          Esta credencial interna permite entrar em qualquer <code>/portal/:slug</code> no modo operador Prymeira, sem usar login do cliente.
        </p>
        <div className="three-col">
          <label>
            Login global
            <input
              ...
              placeholder="ex: operador.prymeira"
            />
          </label>
          <label>
            Senha global
      ...
      <Panel title="Usuários internos e permissões">
        <p className="form-hint">
      ...
      <Panel title="Cores do calendário por técnico">
        <p className="form-hint">
      ...
      <div className="two-col">
        <Panel title="Módulos da jornada">
        ...
        <Panel title="Editor do módulo selecionado">
