        ...
        <>
          ...
          >
            <div className="cohort-detail-summary">
              ...
              <article>
                <span>Status</span>
                <StatusBadge value={statusLabel(data.status)} tone={statusTone(data.status)} />
              </article>
            </div>
          </Panel>

          <div className="two-col cohort-detail-grid">
            <Panel title="Agenda da turma">
                        ...
                        <td>
                          <div className="status-chip-list">
                            {Array.from(new Set(client.statuses)).map((status) => (
                              <StatusBadge key={status} value={statusLabel(status as string)} tone={statusTone(status as string)} />
                            ))}
                          </div>
                        </td>
                      </tr>
