    ...
    <section className="portal-evaluation-screen">
      ...
      <header className="portal-evaluation-header">
        <div className="portal-evaluation-brand">
          <img src={prymeiraHorizontalLogo} alt="Prymeira" />
          <span />
          <div>
      ...
      <section className="portal-evaluation-hero">
        ...
        <div className="portal-evaluation-info-grid">
          ...
          <div>
            ...
            <strong>{certificate.technician_name ?? 'Instrutor Prymeira'}</strong>
          </div>
          <div>
            <label>Turma</label>
      ...
      {participants.length > 0 && !selectedParticipant ? (
        ...
        <footer className="portal-evaluation-submit-area">
          <p><strong>Obrigado pela sua participação.</strong><br />Suas respostas serão usadas exclusivamente para melhoria contínua dos treinamentos Prymeira.</p>
