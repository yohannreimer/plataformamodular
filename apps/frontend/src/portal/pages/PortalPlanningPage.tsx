    ...
    <section className="portal-panel">
      ...
      {items.length === 0 ? (
        <div className="portal-empty-state">
          ...
          <p>Assim que o plano for publicado pela equipe Prymeira, ele aparece aqui automaticamente.</p>
        </div>
      ) : null}
      {items.length > 0 ? (
                ...
                >
                  <td>
                    ...
                    {item.delivery_mode === 'entregavel' ? (
                      <p className="portal-table-subline">
                        Entrega acompanhada pela equipe Prymeira com atualização contínua de status.
                      </p>
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>
                    {item.delivery_mode === 'entregavel' ? (
                      <div className="portal-table-exec">
                        ...
                        <span>Atualizado pela equipe Prymeira</span>
                      </div>
                    ) : (
                      (() => {
