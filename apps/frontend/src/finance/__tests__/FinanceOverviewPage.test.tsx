...
test('FinanceOverviewPage renders the approved executive split-control home', async () => {
  ...
  expect(screen.getByText('Leitura executiva do financeiro da Prymeira.')).toBeInTheDocument();
  ...
  expect(screen.getByRole('link', { name: /A receber/i })).toHaveAttribute('href', '/m/financeiro/receivables');
  ...
  expect(within(queue).getByRole('link', { name: /Conciliar/i })).toHaveAttribute('href', '/m/financeiro/reconciliation');
  expect(within(quickActions).getByRole('link', { name: /Nova receita/i })).toHaveAttribute('href', '/m/financeiro/receivables');
  expect(within(quickActions).getByRole('link', { name: /Conciliar extrato/i })).toHaveAttribute('href', '/m/financeiro/reconciliation');
  expect(within(quickActions).getByRole('link', { name: /Importar extrato/i })).toHaveAttribute('href', '/m/financeiro/reconciliation');
