...
vi.mock('../api', () => ({
  financeApi: {
    listEntities: vi.fn().mockResolvedValue([
      {
        ...
        phone: '(47) 98888-1111',
        is_active: true,
        tags: [{ id: 'tag-cliente', organization_id: 'org-prymeira', name: 'Cliente recorrente', normalized_name: 'cliente recorrente', is_system: true, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }],
      ...
      },
      {
        ...
        phone: '(47) 97777-2222',
        is_active: true,
        tags: [{ id: 'tag-func', organization_id: 'org-prymeira', name: 'Funcionário', normalized_name: 'funcionario', is_system: true, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }],
    ...
    getCatalogSnapshot: vi.fn().mockResolvedValue({
      accounts: [
        { id: 'acc-1', organization_id: 'org-prymeira', company_id: 'comp-1', name: 'Banco principal', kind: 'bank', currency: 'BRL', account_number: null, branch_number: null, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }
      ],
      categories: [
        { id: 'cat-1', organization_id: 'org-prymeira', company_id: 'comp-1', name: 'Receita recorrente', kind: 'income', parent_category_id: null, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }
      ],
      cost_centers: [
        { id: 'cc-1', organization_id: 'org-prymeira', name: 'Operações', code: 'OPS', is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }
      ],
      payment_methods: [
        { id: 'pm-1', organization_id: 'org-prymeira', name: 'PIX', kind: 'pix', is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }
      ]
    }),
    listEntityTags: vi.fn().mockResolvedValue([
      { id: 'tag-func', organization_id: 'org-prymeira', name: 'Funcionário', normalized_name: 'funcionario', is_system: true, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' },
      { id: 'tag-soft', organization_id: 'org-prymeira', name: 'Software', normalized_name: 'software', is_system: true, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }
    ]),
    ...
    setEntityTags: vi.fn().mockImplementation(async (entityId, tagIds) => ({
      ...
      phone: '(47) 99999-0000',
      is_active: true,
      tags: tagIds.map((id: string) => ({ id, organization_id: 'org-prymeira', name: id === 'tag-func' ? 'Funcionário' : 'Software', normalized_name: id, is_system: true, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' })),
      created_at: '2026-04-22T10:00:00.000Z',
      updated_at: '2026-04-22T10:00:00.000Z'
    })),
