...
import type { FinanceEntityDefaultProfile } from '../api';
...
vi.mock('../api', () => ({
  financeApi: {
    ...
    getCatalogSnapshot: vi.fn().mockResolvedValue({
      accounts: [{ id: 'acc-1', organization_id: 'org-prymeira', company_id: 'comp-1', name: 'Banco principal', kind: 'bank', currency: 'BRL', account_number: null, branch_number: null, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }],
      categories: [
        { id: 'cat-1', organization_id: 'org-prymeira', company_id: 'comp-1', name: 'Software', kind: 'expense', parent_category_id: null, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' },
        { id: 'cat-2', organization_id: 'org-prymeira', company_id: 'comp-1', name: 'Eventos', kind: 'expense', parent_category_id: null, is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }
      ],
      cost_centers: [{ id: 'cc-1', organization_id: 'org-prymeira', name: 'Operações', code: 'OPS', is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }],
      payment_methods: [{ id: 'pm-1', organization_id: 'org-prymeira', name: 'PIX', kind: 'pix', is_active: true, created_at: '2026-04-22T09:00:00.000Z', updated_at: '2026-04-22T09:00:00.000Z' }]
    }),
...
function renderPayablesPage() {
  return render(
    <MemoryRouter initialEntries={['/m/financeiro/payables']}>
      <FinancePayablesPage />
    </MemoryRouter>
  );
}
...
test('payables page keeps a manually changed category when entity defaults finish loading later', async () => {
  const { financeApi } = await import('../api');
  let resolveProfile: (value: FinanceEntityDefaultProfile | null) => void = () => undefined;
